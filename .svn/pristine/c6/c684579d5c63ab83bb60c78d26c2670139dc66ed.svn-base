    ...
    public partial class Donation_Email_Tool : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "donor_email_success_pop", "donor_email_success_pop('The new recipient email address has successfully been added!');", true);
                }
            }
            catch (Exception m)
            {
