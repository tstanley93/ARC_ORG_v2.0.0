...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        InsertCommand="INSERT INTO [eNewLetter] ([Issue_Date], [File_Name], [Excerpt]) VALUES (?, ?, ?)" 
        SelectCommand="SELECT * FROM [eNewLetter]" 
        
        UpdateCommand="UPDATE [eNewLetter] SET [Issue_Date] = ?, [File_Name] = ?, [Path] = ?, [Excerpt] = ?, [Flag01] = ?, [Flag02] = ?, [Flag03] = ? WHERE [ID] = ?">
        <DeleteParameters>
        ...
        <InsertParameters>
            <asp:ControlParameter ControlID="Calendar1" Name="Issue_Date" 
                PropertyName="SelectedDate" Type="DateTime" />
            <asp:ControlParameter ControlID="FileUpload1" Name="File_Name" 
                PropertyName="FileName" Type="String" />
            <asp:ControlParameter ControlID="TextBox2" Name="Excerpt" PropertyName="Text" 
                Type="String" />
        </InsertParameters>
