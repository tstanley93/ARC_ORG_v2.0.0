...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        InsertCommand="INSERT INTO Staff(MemberName, MemberDescription, [Order], MemberTitle, MemberPhotoPath) VALUES (@MemberName, @MemberDescription, @Order, @MemberTitle, @MemberPhotoPath)" 
        SelectCommand="SELECT * FROM [Staff] ORDER BY [Order]" 
        UpdateCommand="UPDATE Staff SET MemberName = @MemberName, MemberDescription = @MemberDescription, [Order] = @Order, MemberTitle = @MemberTitle, MemberPhotoPath = @MemberPhotoPath WHERE (ID = @ID)">
        <DeleteParameters>
