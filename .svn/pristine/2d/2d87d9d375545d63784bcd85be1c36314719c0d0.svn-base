...
namespace ARC.ORG
{
	public partial class Main : System.Web.UI.MasterPage
	{
        ...
        {
            DateTime Ldt = Convert.ToDateTime(Literal2.Text);          
            string url = "~/Calendar.aspx" + "?Date=" + Ldt.ToShortDateString();
            Server.Transfer(url);
        }

        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            DateTime Ldt = Convert.ToDateTime(Literal3.Text);
            string url = "~/Calendar.aspx" + "?Date=" + Ldt.ToShortDateString();
            Server.Transfer(url);
        }
        ...
        {
            DateTime Ldt = Convert.ToDateTime(Literal4.Text);
            string url = "~/Calendar.aspx" + "?Date=" + Ldt.ToShortDateString();
            Server.Transfer(url);
        }
        ...
        {
            DateTime Ldt = Convert.ToDateTime(Literal5.Text);
            string url = "~/Calendar.aspx" + "?Date=" + Ldt.ToShortDateString();
            Server.Transfer(url);
        }
        ...
        {
            string url = "~/enewsletter.aspx" + "?FileName=" + Literal10.Text;
            Server.Transfer(url);
        }

        protected void LinkButton6_Click(object sender, EventArgs e)
        {
            string url = "~/enewsletter.aspx" + "?FileName=" + Literal11.Text;
            Server.Transfer(url);
        }
