<%@ Page Title="Board Update Tool" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Board_Update_Tool.aspx.cs" Inherits="ARC.Admin.UserAdmin.Board_Update_Tool" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <div style="margin-left: 150px;">
        <asp:Label ID="Label1" runat="server" Text="Board Update Tool" Font-Size="X-Large" 
    ...
    <div style="margin-left:100px;">
        <h3>Fill out the form below to add a new Boad Member.</h3>
        <br />
        <br />
    ...
    DeleteCommand="DELETE FROM [Board] WHERE [ID] = ?" 
    InsertCommand="INSERT INTO [Board] ([MemberName], [MemberDescription], [Order], [MemberTitle], [MemberPhotoPath]) VALUES (?, ?, ?, ?, ?)" 
    SelectCommand="SELECT ID, MemberName, MemberPhotoPath, MemberDescription, [Order], MemberTitle FROM Board ORDER BY [Order]"                         
    UpdateCommand="UPDATE [Board] SET [MemberName] = ?, [MemberDescription] = ?, [Order] = ?, [MemberTitle] = ?,  [MemberPhotoPath] = ? WHERE [ID] = ?">
        <DeleteParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM Board WHERE (ID = @ID)" 
        InsertCommand="INSERT INTO Board(MemberName, MemberDescription, [Order], MemberTitle, MemberPhotoPath) VALUES (@MemberName, @MemberDescription, @Order, @MemberTitle, @MemberPhotoPath)" 
        SelectCommand="SELECT ID, MemberName, MemberPhotoPath, MemberDescription, [Order], MemberTitle FROM Board ORDER BY [Order]" 
        UpdateCommand="UPDATE Board SET MemberName = @MemberName, MemberDescription = @MemberDescription, [Order] = @Order, MemberTitle = @MemberTitle, MemberPhotoPath = @MemberPhotoPath WHERE (ID = @ID)">
        <DeleteParameters>
            <asp:Parameter Name="ID" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
