...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div style="margin-left:150px; margin-right: 150px;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            DataKeyNames="ID" DataSourceID="SqlDataSource1" ShowHeader="false" GridLines="Both" OnRowEditing="GridView1_OnRowEditing"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM SF_Forms WHERE (ID = @ID)" 
        InsertCommand="INSERT INTO SF_Forms(FormName, FormDescription, FormPath) VALUES (@FormName, @FormDescription, @FormPath)" 
        SelectCommand="SELECT * FROM [SF_Forms]" 
        UpdateCommand="UPDATE SF_Forms SET FormName = @FormName, FormPath = @FormPath, FormDescription = @FormDescription WHERE (ID = @ID)">
        <DeleteParameters>
            <asp:Parameter Name="ID" />
        </DeleteParameters>
        <InsertParameters>
            <asp:ControlParameter ControlID="TextBox1" Name="FormName" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="TextBox3" Name="FormDescription" PropertyName="Text" Type="String" />
        </InsertParameters>        
    </asp:SqlDataSource>
</asp:Content>
