...
namespace ARC.Admin
{
    public partial class Useradmin : System.Web.UI.Page
    {
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            UserTable.Columns.Add("CreationDate", typeof(string));
            UserTable.Columns.Add("LastLoginDate", typeof(string));
            ...
            foreach (MembershipUser mu in muc)
            {
                ...
                tableRow["CreationDate"] = mu.CreationDate.ToShortDateString();
                try
                {
                    tableRow["LastLoginDate"] = mu.LastLoginDate.ToShortDateString();
                }
                catch
                {
                }
        ...
        protected void GridView1_OnRowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            foreach (MembershipUser mu1 in muc)
            {
                ...
                tableRow["CreationDate"] = mu1.CreationDate.ToShortDateString();
                try
                {
                    tableRow["LastLoginDate"] = mu1.LastLoginDate.ToShortDateString();
                }
                catch
                {
                }
        ...
        protected void GridView1_OnRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            //mu.IsLockedOut = ((CheckBox)(row.Cells[3].Controls[0])).Checked;
            Membership.UpdateUser(mu);
            bool IsAdmin = ((CheckBox) (row.Cells[6].Controls[0])).Checked;
            bool IsPicUpdater = ((CheckBox) (row.Cells[7].Controls[0])).Checked;
            bool IsCalUpdater = ((CheckBox) (row.Cells[8].Controls[0])).Checked;
            bool IsNewsUpdater = ((CheckBox) (row.Cells[9].Controls[0])).Checked;
            if (IsAdmin == true)
            {
                try
                {
